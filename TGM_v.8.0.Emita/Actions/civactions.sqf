...
//====================================== BANK ROB =====================================================
action6 = _role addaction ["Steal from safe","bankrob.sqf", ["ausrauben", safe1, "safe1"],1,false,true,"","Safecracked1 and isciv and player distance Safe1 <= 2"];
...
//===================================== CONVOY CASH ===================================================
action48 = _role addaction ["Rob Bank Truck","noscript.sqf",'convoyhascash=false; publicvariable "convoyhascash"; _cash = (playersNumber west)*20000; ["Mishy", _cash] call INV_AddInvItem; player groupchat format["You stole $%1!", _cash];',1,false,true,"","_driver = driver convoytruck; player distance convoytruck <= 7 and convoyhascash and isciv and (!alive _driver or isnull _driver) and (call INV_isArmed)"];
//===================================== BUY INSURANCE ===================================================
...
action223 = _role addaction ["-| Save Vehicle |-","noscript.sqf",'(nearestobjects [getpos player, ["Air", "LandVehicle"], 3] select 0) execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Air", "LandVehicle"], 3] select 0);player distance _vcl < 10 and player distance savepoint < 10 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray'];
actionsave2 = _role addaction ["-| Save Vehicle |-","noscript.sqf",'(nearestobjects [getpos player, ["Air", "LandVehicle"], 3] select 0) execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Air", "LandVehicle"], 3] select 0);player distance _vcl < 10 and player distance savepoint2 < 10 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray'];
//======================================== SLAVES =====================================================
