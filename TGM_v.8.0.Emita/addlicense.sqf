...
if (_art == "add") then 
	...
	if(_license == "Donator_licence2" and !(_uid in Donate2_id)) exitWith { player groupChat "Restriced to Super Donators"};
	...
	if(_license == "sobr_training" and !(iscop)) exitWith {player groupChat "Whitelisted to SWAT"};
