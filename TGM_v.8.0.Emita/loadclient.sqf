...
while {count(loadcontent) == 0} do {
	...
	server globalChat "If your stats have not loaded within 10 seconds please relog.";
	loadtimeout = false;
...
server globalChat format["You are now synced with the UKG database.", loadRewardBonus];
hint "Stat Load Complete, RELOG IF YOU HAVE LOST YOUR STATS!";