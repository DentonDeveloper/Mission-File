...
add_copmoney		 = 4500+donatorcashbonus+admincashbonus;
add_workplace		 = 3000;
...
BuildingsOwnerArray 	 = [];
Homearray = ["Glimmer","Glimmer2","Lane","sample","tr1zkit","tr1zkit_1","Retro1","Redneck","zkb","Angelus","Swody","Short","alfred95","Dutchmen","VBNight","Actual","Dimmer","SGT.Cross","solo6411","VBKilla","Monsieur","Omega","MediaPhamous","Ken","smoothface20","thejojo","Marine","jefw123","lilres_1","lilres_2","lilres_3","lilres_4","lilres_5","lilres_6","lilres_7","lilres_8","jacko1","jacko2","Jacko3","killsteal","Legit","Richards","Kilroy","Jolly","Hodge","Hodge2","Ghengis_Shlong","McRainbow","Tom","Joey","Cookie_Monster","Herzog","xEpicnatorx","Glimmer","Buckwheat_Sniper","Grant","Repp","Doss","AUZ_K1LL3R","Xanxth","kwmx","Fab","hagar","Mcc83","Mcc83_1","Mcc83_2","Telsang_1","Telsang_2","Telsang_3","Hinesy","White","Jesse","UniqeChipmunk_1","Allen","Allen_1","js2195","godiceman","jackygaming","bobthebeastyy","unseen","undeadlegend_1","undeadlegend_2","undeadlegend_3","Hidden_Ops_1","Hidden_Ops_2","Hidden_Ops_3","Mort_1","Mort_2","Mort_3","greenlantern","ghostrecon","ghostrecon2","jgunn","Austin1","Austin2","Austin3","steffan","Shakedown","ElectrifiedGamerHD","Belliosus","Gravvy","Major","Major2","Major3","CurtEvilAlien","Fruerlund","tomcompound","UniqueChipmunk","Blackburn","Dalmiwert","michaelrasch","Fruerlund2","micheal","micheal_2","micheal_3","medic","medic_2","medic_3","blackburn_compound","Darkwage","Lee","TRendoonfire69","CurtEvilAlien_House","willin4akillin","DtownG","Silas","HellDriven","HellDriven_1","Kirby","Kirby_1","RyanHooli","AUZK1LL3R","Harris","Harris_1","Serphantos","Jebus","Jebus_1","Evan","Junior","wloski","MrCole","Hornby","BigBenni","Case_1489","Addiction","Addiction_1","BergerSKG","Test","Test1","Klluge","Klluge_1","Klluge_2"];
