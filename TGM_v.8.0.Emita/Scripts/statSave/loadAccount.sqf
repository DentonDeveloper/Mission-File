...
player groupChat "Loading Account, You will be temporarily player locked and will not be able to move until stats load.";
player groupChat "This is the fastest loading stats save server on arma!";
