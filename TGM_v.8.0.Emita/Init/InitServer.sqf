...
////////////////////////////////
["serverloop1"] execVM "server\commonloop.sqf";
[0, 0, 0, ["serverloop"]] execVM "mayor.sqf";
[0, 0, 0, ["serverloop"]] execVM "chief.sqf";
[0, 0, 0, ["serverloop"]] execVM "gangs.sqf";
//[] execVM "server\governmentconvoy.sqf";
[] execVM "server\druguse.sqf";
[] execVM "server\robpool.sqf";
[] execVM "server\hunting.sqf";
//[] execVM "server\terrorist.sqf";
